...
In the Juypter Hub environment, open the `rest_test` notebook in the `rps-game/roshambo-notebooks` directory. This notebook contains the code to test the AI proxy via REST protocol.
