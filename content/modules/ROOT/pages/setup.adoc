...
You'll be prompted to log in to Argo CD, and you can use the OpenShift login button to do so.
...
- link:{gitea_console_url}/{user}/rps-game-manifests[RPS Game,role='params-link',window='_blank']
