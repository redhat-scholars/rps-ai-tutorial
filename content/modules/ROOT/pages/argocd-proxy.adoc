...
First, we'll install Argo CD in the user namespace. In the *Import Yaml* or *+* button from the top-right corner, copy and paste the following YAML to install Argo CD:
...
The Argo CD web interface is protected by OAuth, and you can log in using the OpenShift credentials, and authorize the Argo CD application to access the OpenShift API. Now, you can access the Argo CD web interface and manage the applications.
